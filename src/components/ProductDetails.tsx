...
const TRUST_BADGES = [
  { icon: Truck, label: "משלוח חינם", sub: "לכל ההזמנות" },
...
export default function ProductDetails({
  ...
  const accordions = [
    ...
    },
    {
      ...
      body: "משלוח חינם בשליחות עד הבית, אספקה תוך 7–14 ימי עסקים. ניתן להחליף או להחזיר פריטים תוך 30 יום מיום הקבלה, כל עוד הם במצב חדש ובאריזתם המקורית.",
    },
    {
