...
export default function ThankYou({
  ...
  return (
    ...
    >
      ...
      <h1 className="mt-6 font-display text-3xl font-black tracking-tight text-zinc-900 sm:text-4xl">
        תודה על ההזמנה!
      </h1>
      ...
      {/* One-click upsell */}
      {product && (
        <section className="mt-12 w-full rounded-2xl border border-[#2952e3]/40 bg-zinc-100 p-6 text-right shadow-[0_20px_60px_-24px_rgba(41,82,227,0.4)] sm:p-8">
          <p className="flex items-center justify-end gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-zinc-500">
            הצעה חד-פעמית
            <Sparkles className="h-4 w-4" strokeWidth={2} />
          </p>
          <div className="mt-4 flex items-center gap-4">
            <div className="relative h-24 w-20 shrink-0 overflow-hidden rounded-xl bg-zinc-200">
            ...
            <div className="flex-1">
              <h2 className="font-display text-lg font-extrabold leading-tight text-zinc-900">
              ...
              <div className="mt-2 flex items-center justify-end gap-2">
                ...
                <span className="font-display text-xl font-black tabular-nums text-zinc-900">
          ...
          <button
            ...
            className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-[#2952e3] px-8 py-3.5 text-sm font-black uppercase tracking-[0.12em] text-white transition-all duration-300 ease-out hover:scale-[1.02] hover:bg-[#4169e5] active:scale-95"
          >
      ...
      <Link
        href="/"
        className="mt-10 text-xs font-bold uppercase tracking-[0.14em] text-zinc-500 underline-offset-4 transition-colors hover:text-zinc-900"
      >
        חזרה לדף הבית
      </Link>
    </main>
