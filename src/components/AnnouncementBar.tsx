...
export default function AnnouncementBar() {
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-[60] h-7 overflow-hidden border-b border-[#2e9bff]/40 bg-black">
      ...
      <div className="relative mx-auto h-full max-w-3xl px-4">
        {MESSAGES.map((msg, i) => (
          <Link
            ...
            className={`absolute inset-0 flex items-center justify-center gap-2 whitespace-nowrap text-center font-sans text-[10px] font-semibold tracking-[0.08em] text-[#cfe6ff] antialiased transition-opacity duration-700 ease-in-out hover:text-white sm:text-[12px] sm:tracking-[0.12em] ${
