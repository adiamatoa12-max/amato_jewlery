  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed left-1/2 top-1/2 z-[90] w-[calc(100%-2.5rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-[#c8a24c]/30 bg-zinc-950 p-7 text-center shadow-2xl transition-all duration-300 sm:p-9 ${
          isOpen
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-7 flex flex-col gap-3">
              <input
                ...
                aria-label="השם שלך"
                placeholder="השם שלך"
                className="w-full rounded-full border border-white/15 bg-black px-5 py-3 text-sm text-white placeholder:text-zinc-500 focus:border-[#c8a24c] focus:outline-none"
              />
              <input
                type="email"
                required
