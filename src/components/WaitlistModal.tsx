  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed left-1/2 top-1/2 z-[90] w-[calc(100%-2.5rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-zinc-200 bg-surface p-7 text-center shadow-2xl transition-all duration-300 sm:p-9 ${
          isOpen
      ...
      >
        <button
          ...
          onClick={closeWaitlist}
          aria-label="סגירה"
          className="absolute left-2 top-2 flex h-11 w-11 items-center justify-center text-zinc-500 transition-colors duration-300 hover:text-zinc-900"
        >
        ...
        {status === "done" ? (
          <div className="flex flex-col items-center py-4">
            ...
            <h2 className="mt-5 font-display text-2xl font-black tracking-tight text-zinc-900">
              אתם ברשימה!
            </h2>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-7 flex flex-col gap-3">
              ...
              <input
                ...
                dir="ltr"
                className="w-full rounded-full border border-zinc-300 bg-surface px-5 py-3 text-right text-sm text-zinc-900 placeholder:text-zinc-500 focus:border-[#2952e3] focus:outline-none"
              />
              <input
                type="tel"
                inputMode="tel"
              ...
              <button
                ...
                className="mt-1 inline-flex w-full items-center justify-center rounded-full bg-[#2952e3] px-8 py-3.5 text-sm font-black uppercase tracking-[0.12em] text-white transition-all duration-300 ease-out hover:scale-105 hover:bg-[#4169e5] active:scale-95 disabled:cursor-not-allowed disabled:opacity-60"
              >
