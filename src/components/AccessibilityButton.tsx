...
export default function AccessibilityButton() {
  ...
  return (
    <div className="fixed bottom-[4.75rem] left-4 z-[55] flex flex-col items-start gap-3 sm:left-6 lg:bottom-6">
      {/* Settings panel */}
      {open && (
        <div
          role="dialog"
      ...
      <button
        ...
        aria-label="הגדרות נגישות"
        aria-expanded={open}
        className="flex h-12 w-12 items-center justify-center rounded-full border border-zinc-200 bg-white text-zinc-900 shadow-md ring-1 ring-transparent transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:ring-[#2952e3]/70"
      >
