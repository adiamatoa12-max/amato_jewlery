  ...
  return (
    <div className="fixed bottom-6 left-5 z-[55] flex flex-col items-start gap-3 sm:left-6">
      ...
      <button
        ...
        aria-label="הגדרות נגישות"
        aria-expanded={open}
        className="flex h-12 w-12 items-center justify-center rounded-full bg-neutral-900 text-white shadow-[0_10px_30px_-8px_rgba(0,0,0,0.45)] ring-1 ring-white/10 transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:ring-[#c8a24c]/70 hover:shadow-[0_16px_38px_-10px_rgba(0,0,0,0.55)]"
      >
