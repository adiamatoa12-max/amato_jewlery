  ...
  "geo-pendant-necklace": [
    {
      ...
      rating: 5,
      date: "אפריל 2026",
      body: "חיפשתי הרבה זמן תכשיט מינימליסטי שנראה יוקרתי בלי להיות מוגזם, והשרשרת שהזמנתי מ-PULSE בדיוק ענתה על מה שחיפשתי. היא עדינה, איכותית ומשתלבת כמעט עם כל לוק. אחרי כמה שבועות של שימוש יומיומי היא עדיין נראית חדשה לגמרי. בהחלט אזמין שוב.",
      verified: true,
    },
  ],
};
