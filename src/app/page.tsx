...
const STEPS = [
  ...
  },
  {
    icon: CupSoda,
    title: "נהנים",
    body: "נצמד בכל מקום. ידיים חופשיות והאימון מתועד.",
  },
];
        ...
        <FadeIn>
          <div className="text-right">
            ...
            <p className="mt-6 max-w-md text-base leading-[1.7] text-[#2D3748] lg:text-lg">
              מגנט חזק המאפשר להצמיד את הטלפון שלך בכל מקום ובכל זמן.{" "}
...
const RING_OPTIONS = [
  { title: "אופציה 1", body: "לטלפון עם מגנט מובנה — מצמידים ישירות, בלי הדבקה." },
  { title: "אופציה 2", body: "מדביקים את המגנט ישירות על גב המכשיר." },
  { title: "אופציה 3", body: "מדביקים את המגנט על גבי הכיסוי." },
];
...
const REVIEWS = [
  ...
  },
  {
    ...
    role: "יוגה ופילאטיס",
    rating: 4,
    text: "עיצוב נקי ויוקרתי שנצמד לכל מקום. הייתי שמחה לעוד צבעים, אבל מעולה!",
  },
];
