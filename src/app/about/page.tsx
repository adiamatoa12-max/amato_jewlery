...
const PILLARS = [
  {
    icon: ShieldCheck,
    title: "עמידות",
    body: "גוף טריטן (Tritan) שקוף ונטול BPA שסופג אימון אחרי אימון בלי להתעייף. משקיעים פעם אחת ולא קונים שייקר חדש כל חודש.",
  },
  {
    icon: Magnet,
    title: "חדשנות",
    body: "מגנט שמצמיד את הטלפון תוך שנייה, בדיוק בגובה העיניים. בלי תמיכות מתפרקות ובלי לחפש איפה להניח אותו.",
  },
  {
    icon: Dumbbell,
    title: "בלי נזילות",
          ...
          <FadeIn delay={120}>
            <div dir="rtl" className="mx-auto mt-8 max-w-2xl space-y-5">
              <p className="text-lg font-medium leading-[1.8] text-[#2D3748]">
                מותג VAULT נולד מתסכול פשוט: נמאס לנו משייקרים מסורבלים ונוזלים
                שמסתובבים בחדרי הכושר. רצינו את השייקר המושלם לספורטאים — כזה
                שמשלב{" "}
        ...
        <section className="mx-auto max-w-3xl px-5 py-12 text-center sm:px-6 lg:py-16">
          ...
          <FadeIn delay={120}>
            <p className="mx-auto mt-8 max-w-2xl font-display text-2xl font-black leading-relaxed text-[#111111] lg:text-3xl">
              ציוד אימון שעובד בשבילך, לא נגדך. פחות בלגן, יותר זמן להתאמן.
            </p>
          </FadeIn>
        </section>
      </main>
