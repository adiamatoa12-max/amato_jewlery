...
export const COLLECTIONS: MockCollection[] = [
  {
    ...
    tagline: "השייקר החשמלי שנצמד למכונה ומערבב שייק חלק — עם מעמד טלפון מובנה.",
    products: [
      {
        ...
        description:
          "השייקר החשמלי עם מעמד טלפון מובנה. מנוע חזק שמערבב את החלבון חלק בשניות בלי גושים, ומגנט N52 שמצמיד את הטלפון לכל מכונה — לצילום ולסטרימינג בגובה העיניים. אטום 100% שלא מדליף טיפה, וגוף טריטן (Tritan) שקוף נטול BPA. כל מארז כולל שתי טבעות מגנטיות מתאימות.",
        price: 199,
        currency: "ILS",
        material: MATERIAL,
